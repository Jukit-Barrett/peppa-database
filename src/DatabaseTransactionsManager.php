...
class DatabaseTransactionsManager
{
     ...
     * @return void
     */
    public function begin(string $connection, int $level)
    {
        $this->transactions[] = new DatabaseTransactionRecord($connection, $level);
    }
     ...
     * @return void
     */
    public function rollback(string $connection, int $level)
    {
